...
const typeMap: any = {
  ...
  Extensions: o([{ json: "none", js: "none", typ: 3.14 }], false),
  Header: o(
    [
      ...
      {
        json: "FilePercentExtension",
        js: "FilePercentExtension",
        typ: r("Extensions"),
      },
    ],
    false,
  ),
  MajorTypes: o([{ json: "application", js: "application", typ: 0 }], false),
  MIMETypes: o(
    [
      {
        json: "application/x-mach-binary",
        js: "application/x-mach-binary",
        typ: 0,
      },
    ],
    false,
